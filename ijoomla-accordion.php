...
/*
Plugin Name: 	iJoomla! Accordion
Plugin URI:  	https://ijoomla.org/wordpress-plugins/introductions/ijoomla-accordion/
...
iJoomla! Accordion is free software: you can redistribute it and/or modify
it under the terms of the GNU General Public License as published by
the Free Software Foundation, either version 2 of the License, or
any later version.

iJoomla! Accordion is distributed in the hope that it will be useful,
but WITHOUT ANY WARRANTY; without even the implied warranty of
MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
GNU General Public License for more details.

You should have received a copy of the GNU General Public License
along with iJoomla! Accordion. If not, see https://www.gnu.org/licenses/gpl-2.0.html.
*/
...
// Creating the widget
class wpiccordion_widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			// Base ID of your widget
			'wpiccordion_widget',
			// Widget name will appear in UI
			__('iJoomla Accordion', 'wpiccordion_widget_domain'),
			// Widget description
			array( 'description' => __( 'Responsive accordion widget for WordPress, created by iJoomla.org.', 'wpiccordion_widget_domain' ), )
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		echo __( '', 'wpiccordion_widget_domain' );
		...
		<div class="iccordion_style_<?php echo $style; ?>">
			<div class="iccordion" id="iccordion<?php echo $module->id; ?>">
				...
				<?php if($heading9){ ?>
					<section class="iccordion_tab" id="iccordion_tab9">
						<div class="iccordion_heading">
				...
				<?php if($heading11){ ?>
					<section class="iccordion_tab" id="iccordion_tab11">
						<div class="iccordion_heading">
				...
				<?php if($heading12){ ?>
					<section class="iccordion_tab" id="iccordion_tab12">
						<div class="iccordion_heading">
				...
				<?php if($heading13){ ?>
					<section class="iccordion_tab" id="iccordion_tab13">
						<div class="iccordion_heading">
				...
				<?php if($heading14){ ?>
					<section class="iccordion_tab" id="iccordion_tab14">
						<div class="iccordion_heading">
				...
				<?php if($heading15){ ?>
					<section class="iccordion_tab" id="iccordion_tab15">
						<div class="iccordion_heading">
				...
				<?php if($heading16){ ?>
					<section class="iccordion_tab" id="iccordion_tab16">
						<div class="iccordion_heading">
				...
				<?php if($heading17){ ?>
					<section class="iccordion_tab" id="iccordion_tab17">
						<div class="iccordion_heading">
				...
				<?php if($heading18){ ?>
					<section class="iccordion_tab" id="iccordion_tab18">
						<div class="iccordion_heading">
				...
				<?php if($heading19){ ?>
					<section class="iccordion_tab" id="iccordion_tab19">
						<div class="iccordion_heading">
				...
				<?php if($heading20){ ?>
					<section class="iccordion_tab" id="iccordion_tab20">
						<div class="iccordion_heading">
	...
	public function form( $instance ) {
		...
		{
			$title = __( 'New title', 'wpiccordion_widget_domain' );
		}
...
function wpaccrd_load_plugin_css() {
    $plugin_url = plugin_dir_url( __FILE__ );

    wp_enqueue_style( 'mastercss_accrdn', $plugin_url . 'styles/master.css' );
}
add_action( 'wp_enqueue_scripts', 'wpaccrd_load_plugin_css' );

function wpaccrd_load_plugin_js() {
	$plugin_url = plugin_dir_url( __FILE__ );

	wp_enqueue_script( 'jquery-core' );
    wp_enqueue_script( 'masterjs_accrdn', $plugin_url . 'scripts/master.js' );
}
add_action( 'wp_enqueue_scripts', 'wpaccrd_load_plugin_js' );

// Class wpiccordion_widget ends here
// Register and load the widget
function wpiccordion_load_widget() {
    register_widget( 'wpiccordion_widget' );
}
add_action( 'widgets_init', 'wpiccordion_load_widget' );

=== iJoomla Accordion Plugin ===

Contributors: yutab
Donate link: https://www.paypal.me/ijoomla
Tags: accordion, Wordpress accordion, Wordpress accordion plugin, Wordpress accordion widget, Wordpress accordion add-on, accordion widget, content, slider, content slider, wp accordion, content
...
iJoomla! Accordion Plugin creates unlimited Accordion widgets on WordPress websites.

== Description ==

This product is a fully responsive WordPress widget and displays Accordions in a fancy style. The widget output is very customizable and easy to work with. There are various options on the admin panel to take the appearance and behavior of each widget instance under your control. Some of the options are described below.
...
iJoomla! Accordion is created by [iJoomla.org](https://ijoomla.org/) as a free WordPress plugin. But, though it’s a free product, it’s fully supported by iJoomla.org.
...
iJoomla! Accordion Plugin for WordPress has 5 built-in styles and it’s very easy to add your custom style to it as well.
...
Customization:
As described this product is very flexible and easy to customize. You can easily change the style of its module output by editing the plugin CSS file at wp-content/plugins/ijoomla-accordion/styles/master.css.
